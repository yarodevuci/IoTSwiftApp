...
class ViewController: UIViewController {
    ...
    var exteriorTemperature: Int = 35;
    ...
    func updateStatus( interiorTemperature: Int?, exteriorTemperature: Int?, state: String? )
    {
        ...
        if let state = state {
            ...
            {
            case "stopped":
                StatusLable.text = "Disabled"
                StatusLable.textColor = UIColor(red:0.0, green: 0.0, blue: 0.0, alpha: 1.0)
                interiorLabel.textColor = UIColor(red:1.0, green: 0.0, blue: 0.0, alpha: 1.0)
            case "heating":
                interiorLabel.textColor = UIColor(red:1.0, green: 0.0, blue: 0.0, alpha: 1.0)
                StatusLable.text = "Heating the room"
                StatusLable.textColor = UIColor(red:1.0, green: 0.0, blue: 0.0, alpha: 1.0)
            case "cooling":
                interiorLabel.textColor = UIColor(red:0.0, green: 0.0, blue: 1.0, alpha: 1.0)
                StatusLable.text = "Cooling the room"
                StatusLable.textColor = UIColor(red:0.0, green: 0.0, blue: 1.0, alpha: 1.0)
            default:
